#
#  Be sure to run `pod spec lint MarchingLayer.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "MarchingLayer"
  s.version      = "0.0.1"
  s.summary      = "Randomly fills layer with sprites and move them in any direction and speed you want."
...
Call `startAnimation()` to start, `stopAnimation()` to stop marching animation.
  ...
  s.homepage     = "https://github.com/cemolcay/MarchingLayer"
  ...
  s.source       = { :git => "https://github.com/cemolcay/MarchingLayer.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "MarchingLayer/MarchingLayer.swift"
